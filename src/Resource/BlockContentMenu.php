 ...
 * @internal
 */
class BlockContentMenu extends EntityQueryResourceBase {
  ...
  public function process(Request $request): ResourceResponse {
    ...
    $entity_query = $this->getEntityQuery('block_content')->condition('field_domain_access', $confTheme['default'])->condition('type', 'menus');
